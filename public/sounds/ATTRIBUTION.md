...
Sound effects in this folder are sourced from free, royalty-free libraries.

## Files

| File | Source | License | Description |
|------|--------|---------|-------------|
| `game-start.mp3` | [Mixkit](https://mixkit.co) | Mixkit License | Fantasy game success notification |
...
- **CC0 (Public Domain)**: Free to use, modify, and distribute without restriction. [Details](https://creativecommons.org/publicdomain/zero/1.0/)
